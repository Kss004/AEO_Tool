...
export function InputForm() {
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="space-y-5 rounded-2xl border border-zinc-800 bg-zinc-900/40 p-4 shadow-xl backdrop-blur sm:p-6"
    >
      ...
      <div className="flex flex-col gap-4 pt-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          ...
          className="w-full rounded-lg bg-emerald-500 px-5 py-2.5 font-medium text-emerald-950 transition hover:bg-emerald-400 disabled:cursor-not-allowed disabled:bg-zinc-700 disabled:text-zinc-500 sm:w-auto"
        >
  ...
  return (
    <label className="flex flex-col gap-1.5 text-sm">
      ...
      <input
        ...
        required={required}
        className="rounded-lg border border-zinc-800 bg-black/40 px-3 py-2.5 text-base text-zinc-100 placeholder:text-zinc-600 focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 sm:text-sm"
      />
    </label>
  );
}
